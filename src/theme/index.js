export default {
	...
	"font": {
		...
		"headline2": "normal 700 45px/60px --fontFamily-googleUbuntu",
		"headline3": "normal 400 35px/45px --fontFamily-googleUbuntu",
		"base": "normal 300 16px/1.5 --fontFamily-sans",
		"lead": "normal 300 20px/1.5 --fontFamily-sans",
		"menu": "normal 16px/24 Ubuntu",
		"h2": "700 45px/60px --fontFamily-googleUbuntu"
	},
	"boxShadow": {
